						...
						<div class="card">
							...
							<div class="card-footer d-flex flex-wrap justify-content-between">
								...
								<div>
									...
									<a href="javascript:void(0);" class="btn btn-warning btn-md me-2 mb-2"><i class="fas fa-share-alt me-2"></i>Share Profile</a>
									<a href="javascript:void(0);" class="btn btn-info btn-md me-2 mb-2"><i class="fas fa-phone-alt me-2"></i>Contact</a>
								</div>
							</div>
						</div>
					</div>
